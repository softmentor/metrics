...
//      }
   ...
   * (non-Javadoc)
   * 
   * @see redis.clients.jedis.Jedis#hmget(java.lang.String,
   * java.lang.String[])
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see redis.clients.jedis.Jedis#rpush(java.lang.String,
   * java.lang.String[])
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see redis.clients.jedis.Jedis#lpush(java.lang.String,
   * java.lang.String[])
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see redis.clients.jedis.Jedis#publish(java.lang.String,
   * java.lang.String)
   */
  @Override
   ...
   * 
   * @see
   * redis.clients.jedis.Jedis#psubscribe(redis.clients.jedis.JedisPubSub,
   * java.lang.String[])
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see redis.clients.jedis.Jedis#zcount(java.lang.String, java.lang.String,
   * java.lang.String)
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see redis.clients.jedis.Jedis#zremrangeByRank(java.lang.String, long,
   * long)
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see redis.clients.jedis.Jedis#configSet(java.lang.String,
   * java.lang.String)
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see redis.clients.jedis.Jedis#eval(java.lang.String, int,
   * java.lang.String[])
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see redis.clients.jedis.Jedis#eval(java.lang.String, java.util.List,
   * java.util.List)
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see redis.clients.jedis.Jedis#evalsha(java.lang.String, java.util.List,
   * java.util.List)
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see redis.clients.jedis.Jedis#evalsha(java.lang.String, int,
   * java.lang.String[])
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see redis.clients.jedis.BinaryJedis#zrevrangeWithScores(byte[], int,
   * int)
   */
  @Override
   ...
   * 
   * @see
   * redis.clients.jedis.BinaryJedis#multi(redis.clients.jedis.TransactionBlock
   * )
   */
  @Override
   ...
   * 
   * @see
   * redis.clients.jedis.BinaryJedis#pipelined(redis.clients.jedis.PipelineBlock
   * )
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see redis.clients.jedis.BinaryJedis#zrangeByScore(byte[], double,
   * double)
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see redis.clients.jedis.BinaryJedis#zrangeByScore(byte[], byte[],
   * byte[])
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see redis.clients.jedis.BinaryJedis#zremrangeByScore(byte[], byte[],
   * byte[])
   */
  @Override
   ...
   * 
   * @see
   * redis.clients.jedis.BinaryJedis#monitor(redis.clients.jedis.JedisMonitor)
   */
  @Override
   ...
   * 
   * @see
   * redis.clients.jedis.BinaryJedis#debug(redis.clients.jedis.DebugParams)
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see redis.clients.jedis.BinaryJedis#subscribe(redis.clients.jedis.
   ...
   * (non-Javadoc)
   * 
   * @see redis.clients.jedis.BinaryJedis#psubscribe(redis.clients.jedis.
   * BinaryJedisPubSub, byte[][])
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see redis.clients.jedis.BinaryJedis#eval(byte[], java.util.List,
   * java.util.List)
   */
  @Override
  ...
  /*
   * private void returnJedis(Jedis jedis) { try { if (jedis.isConnected()) {
   * jedis.ping(); jedisPool.returnResource(jedis); } else {
   * jedisPool.returnBrokenResource(jedis); } } catch (JedisException e) {
   * jedisPool.returnBrokenResource(jedis); } }
   * 
   * private MetricName buildMetricName(Method m, String scope) { Class<?>
   * clazz = m.getDeclaringClass(); String metricName = m.getName(); return
   * new MetricName(clazz, metricName, scope); }
   * 
   * private Timer buildTimer(MetricsRegistry registry, MetricName metricName)
   * { return registry.newTimer(metricName, TimeUnit.MILLISECONDS,
   * TimeUnit.SECONDS); }
   */
